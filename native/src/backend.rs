...
const BACKEND_NAME: &str = "logic-analyzer-mcp-backend.exe";
const BACKEND_PORT: u16 = 10985;
const BACKEND_TAG: &str = "logic-analyzer-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "LOGIC_ANALYZER_MCP_PORT";
const ENV_HOST: &str = "LOGIC_ANALYZER_MCP_HOST";
const ENV_TAURI: &str = "LOGIC_ANALYZER_MCP_TAURI";
