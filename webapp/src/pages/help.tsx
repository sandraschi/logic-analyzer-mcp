    ...
    <div className="max-w-3xl prose prose-invert">
      ...
      <section className="rounded-xl border border-zinc-800 bg-zinc-900 p-6 mb-4 text-sm space-y-3">
        ...
        <ol className="list-decimal list-inside text-zinc-300 space-y-1 font-mono text-xs">
          ...
          <li>la_capture(operation=&quot;single&quot;, sample_rate_hz=1000000, sample_count=4096)</li>
      ...
      <section className="rounded-xl border border-zinc-800 bg-zinc-900 p-6 text-sm">
        ...
        <ul className="text-zinc-300 space-y-2">
          <li><strong className="text-cyan-300">Hantek 6022BL</strong> — flip H/P for LA mode; sigrok fx2lafw (8ch @ 24 MHz)</li>
          <li><strong className="text-cyan-300">DSLogic</strong> — dedicated LA; sigrok dslogic driver</li>
          <li><strong className="text-cyan-300">Pair with oscilloscope-mcp</strong> — analog rails + digital buses</li>
        </ul>
      </section>
    </div>
  );
